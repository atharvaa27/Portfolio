...
const projects = [
  ...
  {
    title: "Enterprise LLM Automation Platform",
    organization: "HCL Tech",
    stage: "USA · Nov 2024 - Jul 2025",
    summary:
      "Designed and deployed LLM-powered enterprise applications using RAG, LangChain, OpenAI, and vector databases to improve response relevance and automate knowledge workflows.",
    metricLabel: "Response relevance",
    metric: "+40%",
    metricDetail:
      "after adding retrieval-augmented generation with Pinecone, ChromaDB, and evaluated prompt workflows.",
    outcomes: [
      "Built FastAPI, Flask, and microservice-based backend services for AI/ML model serving in high-concurrency production environments.",
      "Fine-tuned transformer-based NLP models with PyTorch and Hugging Face for classification and entity recognition tasks.",
      "Implemented prompt evaluation, A/B testing, Airflow, MLflow, and Kubeflow pipelines for training, tracking, and model versioning.",
      "Optimized inference with ONNX, Triton Inference Server, quantization, AWS, and Azure ML, then surfaced results through React and Node.js applications.",
    ],
    stack: [
      "LangChain",
      "OpenAI",
    ...
    signals: [
      { label: "LLM", value: "RAG + prompt evaluation" },
      { label: "Serving", value: "FastAPI, Flask, microservices" },
      { label: "Models", value: "PyTorch + Hugging Face" },
      { label: "Cloud", value: "AWS + Azure ML" },
    ],
    pipeline: ["Retrieve", "Generate", "Evaluate", "Serve"],
    boardTitle: "LLM automation stack",
    accent: "#c8a0ff",
  ...
  },
  {
    ...
    stage: "India · Jan 2021 - Jul 2023",
    summary:
      "Developed ML, NLP, and early LLM applications for enterprise analytics, intelligent document search, model-serving APIs, and near real-time data workflows.",
    metricLabel: "Core capability",
    metric: "+30%",
    metricDetail:
      "improved information retrieval accuracy through prompt engineering, RAG concepts, and production NLP workflows.",
    outcomes: [
      "Developed classification, regression, and clustering models with Scikit-learn and TensorFlow across multiple business use cases.",
      "Integrated Hugging Face Transformers for text classification and entity recognition in production workflows.",
      "Built Flask and FastAPI model-serving APIs plus Python, Pandas, SQL, Spark, and Kafka data pipelines.",
      "Tracked experiments with MLflow, deployed applications with Docker, and supported Jenkins and Git-based CI/CD releases.",
    ],
    stack: [
      "Python",
      "Scikit-learn",
    ...
    signals: [
      { label: "Models", value: "Classification, regression, clustering" },
      { label: "NLP", value: "Transformers, NER, text classification" },
      { label: "Data", value: "SQL, Spark, Kafka" },
      { label: "Delivery", value: "Docker, Jenkins, Git" },
    ],
    pipeline: ["Process", "Model", "Track", "Deploy"],
    ...
    <div className="work-section" id="work">
      <div className="work-container section-container">
        <div className="work-header">
          ...
          <p>
            Real work shipped across research and enterprise AI systems:
            production ML pipelines, LLM services, RAG applications, model-serving
            APIs, and decision support built for actual operational use.
          </p>
        </div>
